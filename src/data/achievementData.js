export const achievementData = {
    ...
    achievements : [
        {
            id : 1,
            title : 'Second Runner Up - University Project Show',
            details : 'News Center Project is the medial project and your ability with true Information.',
            date : 'Aug 20, 2018',
            field : 'Automation',
        ...
        {
            id : 2,
            title : 'Grand Winner - ICT Project Show',
